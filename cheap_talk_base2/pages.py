...
class Startup(WaitPage):
    ...
    def after_all_players_arrive(self):
        ...
        sender1.signal = sender1.participant.vars['signal2']
        sender2.signal = sender2.participant.vars['signal2']
...
class ResultsWaitPage2(WaitPage):
    ...
    def after_all_players_arrive(self):
        ...
        sender1.participant.vars['signal2'] = sender1.signal
        sender2.participant.vars['signal2'] = sender2.signal

        sender1.participant.vars['message2'] = sender1.message
        sender2.participant.vars['message2'] = sender2.message

        sender1.participant.vars['othermessage2'] = sender2.message
        sender2.participant.vars['othermessage2'] = sender1.message

        sender1.participant.vars['receiversuccess2'] = receiver.winner
        sender2.participant.vars['receiversuccess2'] = receiver.winner

        sender1.participant.vars['winner2'] = sender1.winner
        sender2.participant.vars['winner2'] = sender2.winner

        receiver.participant.vars['choice2'] = receiver.choice
        receiver.participant.vars['winner2'] = receiver.winner

        receiver.participant.vars['messageA2'] = sender1.message
        receiver.participant.vars['messageB2'] = sender2.message

        receiver.participant.vars['signalA2'] = sender1.signal
        receiver.participant.vars['signalB2'] = sender2.signal

        for p in players:
            p.participant.vars['timeout2'] = p.timeout
